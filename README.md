...
2. Classifique os feedbacks por:
...
3. Use as seguintes categorias de sentimento:
...
5. Calcule a **frequência** e o **percentual** de cada tema com base no total de feedbacks válidos. Mostre o denominador utilizado e não estime números ausentes.
...
9. Priorize os problemas considerando:
...
10. Sugira ações práticas, indicando:
